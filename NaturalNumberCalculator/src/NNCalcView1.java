...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         * to bottom
         */
        // Final integers to avoid magic number warning
        final int three = 3, four = 4, five = 5, six = 6, seven = 7, eight = 8,
                nine = 9;
    ...
    // Method to enable or disable the subtraction button based on a boolean value
    @Override
    ...
    // Method to enable or disable the division button based on a boolean value
    @Override
    ...
    // Method to enable or disable the power button based on a boolean value
    @Override
    ...
    // Method to enable or disable the root button based on a boolean value
    @Override
